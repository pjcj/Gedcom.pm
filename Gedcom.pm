...
use Gedcom::Grammar    1.14;
use Gedcom::Individual 1.14;
use Gedcom::Family     1.14;
use Gedcom::Event      1.14;
...
Gedcom.pm is Copyright 1999-2004, Paul Johnson (pjcj@cpan.org)
